...
var displayColumns = map[string][]colSpec{
	...
	"AutomationRuleItem": {
		{Header: "ID", Field: "RuleID"},
		{Header: "NAME", Field: "Name", MaxWidth: 40},
		{Header: "TEAM", Field: "TeamID"},
		{Header: "ENABLED", Field: "Enabled"},
		{Header: "SCHEDULE", Field: "ScheduleTriggerEnabled"},
		{Header: "POST", Field: "HTTPPostTriggerEnabled"},
		{Header: "CRON", Field: "CronExpr"},
		{Header: "UPDATED", Field: "UpdatedAt"},
	},
	"AutomationRunItem": {
		{Header: "RUN_ID", Field: "RunID"},
		{Header: "RULE_ID", Field: "RuleID"},
		{Header: "STATUS", Field: "Status"},
		{Header: "TRIGGER", Field: "TriggerKind"},
		{Header: "STARTED", Field: "StartedAt"},
		{Header: "DURATION_MS", Field: "DurationMs"},
		{Header: "ATTEMPTS", Field: "Attempts"},
		{Header: "ERROR", Field: "ErrorMessage", MaxWidth: 50},
	},
	"AutomationTemplateItem": {
		{Header: "NAME", Field: "Name", MaxWidth: 40},
		{Header: "ENABLED", Field: "Enabled"},
		{Header: "DESCRIPTION", Field: "Description", MaxWidth: 50},
		{Header: "PROMPT", Field: "Prompt", MaxWidth: 80},
	},
	"TeamItem": {
