...
Response fields ('data' envelope is unwrapped — these fields are at the top level):
  ...
  - created_at (string) (required) — Unix timestamp in seconds when the resource was created. Also anchors the start of the first billing window. CLI '--json' renders this as an RFC3339 string in the process's local timezone (NOT UTC, and NOT the wire integer); an unset value renders as null.
  - error.days (integer) (required) — Retention period in days for error data.
  - expired_at (string) — Unix timestamp in seconds when the on-premises license expires. Only present on on-premises deployments; omitted entirely for SaaS accounts. CLI '--json' renders this as an RFC3339 string in the process's local timezone (NOT UTC, and NOT the wire integer); an unset value renders as null.
  ...
  - updated_at (string) (required) — Unix timestamp in seconds when the resource was last updated. CLI '--json' renders this as an RFC3339 string in the process's local timezone (NOT UTC, and NOT the wire integer); an unset value renders as null.
  ...
  - window_end_time (string) (required) — Unix timestamp in seconds for the end of the current 30-day billing window. CLI '--json' renders this as an RFC3339 string in the process's local timezone (NOT UTC, and NOT the wire integer); an unset value renders as null.
  - window_start_time (string) (required) — Unix timestamp in seconds for the start of the current 30-day billing window. CLI '--json' renders this as an RFC3339 string in the process's local timezone (NOT UTC, and NOT the wire integer); an unset value renders as null.
`,
